...
MIDSCENE_USE_ANTHROPIC = "MIDSCENE_USE_ANTHROPIC"

# Anthropic/Claude 模型配置键
MIDSCENE_ANTHROPIC_API_KEY = "MIDSCENE_ANTHROPIC_API_KEY"
MIDSCENE_ANTHROPIC_BASE_URL = "MIDSCENE_ANTHROPIC_BASE_URL"
MIDSCENE_ANTHROPIC_MODEL_NAME = "MIDSCENE_ANTHROPIC_MODEL_NAME"

# 有效的模型家族值 - 与 JS 版本 MODEL_FAMILY_VALUES 对齐
# (packages/shared/src/env/types.ts:289)
# 注：'claude' 是 Python 端对 Anthropic 原生协议的扩展,JS 端无此家族
MODEL_FAMILY_VALUES = [
    "doubao-vision",
    "gemini",
    "qwen2.5-vl",
...
# 额外环境变量 - 与 JS 对齐 (packages/shared/src/env/types.ts:4-79)
...
# Android ADB 环境变量 - 对齐 JS packages/shared/src/env/types.ts
...
# IME 策略常量
IME_STRATEGY_ALWAYS_YADB = "always-yadb"
IME_STRATEGY_YADB_FOR_NON_ASCII = "yadb-for-non-ascii"
IME_STRATEGY_ADB_KEYBOARD = "adb-keyboard"

# iOS WebDriverAgent 环境变量
MIDSCENE_WDA_HOST = "MIDSCENE_WDA_HOST"
MIDSCENE_WDA_PORT = "MIDSCENE_WDA_PORT"
MIDSCENE_WDA_TIMEOUT = "MIDSCENE_WDA_TIMEOUT"
MIDSCENE_WDA_BASE_URL = "MIDSCENE_WDA_BASE_URL"

DEFAULT_WDA_PORT = 8100
DEFAULT_WDA_HOST = "localhost"
...
__all__ = [
    ...
    "MIDSCENE_ANTHROPIC_BASE_URL",
    "MIDSCENE_ANTHROPIC_MODEL_NAME",
    "MIDSCENE_USE_ANTHROPIC",
